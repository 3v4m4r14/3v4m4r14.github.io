...
image: /assets/img/posts/lucy/lucy.019.jpeg
description: "This blog post is part of an application for Toptal Scholarships for Women: Empowering Future Female Leaders to Change the World."
tags:
  - application
  - business
  - health
...
![](/assets/img/posts/lucy/lucy.014.jpeg)
...
According to the World Bank, in [2017 we had 3.73 billion women](https://data.worldbank.org/indicator/SP.POP.TOTL.FE.IN). At least half of them are fertile and, as a result, could use my technological solution. Of course, the actual numbers depend largely on how accessible the product would be. I believe that we should all have more choice and control over our own bodies which is why my goal is to make this available to every woman on the planet, no matter their financial, social, or cultural background.
...
![](/assets/img/posts/lucy/lucy.006.jpeg)
...
Link to Lean Canvas: [https://canvanizer.com/canvas/rFvH88L9pJ9Lp](https://canvanizer.com/canvas/rFvH88L9pJ9Lp)
...
![](/assets/img/posts/lucy/lucy.015.jpeg)
...
![](/assets/img/posts/lucy/lucy.019.jpeg)
...
_Note: I did not get the scholarship._